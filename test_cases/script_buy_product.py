...
class BuyProductScript(InterfaceCase):
    ...
    def test_buy_quarkZX30(self):
        ...
        if amount=="" or times=="" or exec_flag=="" or load_create=="":
            self.logger.info("BuyProductScript.test_buy_quarkZX30: buy_info excel parms is wrong!")
            return "buy_info excel parms is wrong!"


        elif exec_flag=='N' or times=='0':
            self.logger.info('BuyProductScript.test_buy_quarkZX30: do not buy product quarkZX30!')
        ...
        if load_create=='N':
            ...
            self.logger.info("BuyProductScript.test_buy_quarkZX30: user_phone pwd value can not be null!")
        ...
        for i in xrange(int(times)):
            ...
            self.logger.info("BuyProductScript.test_buy_quarkZX30:run {one} time;"
                             "phone is {two};"
                             "pwd is {three};"
                             "product is {four};"
